...
│   ├── blocker/               # Everything related to blocking users
│   │   ├── components/
│   │   │   ├── Blocker.tsx
│   │   │   └── BlockUserButton.tsx
│   │   ├── hooks/
...
│   │
│   └── factcheck/             # Everything related to AI fact-checking
│       ├── agents/
│       ├── components/
│       │   └── FactCheckButton.tsx
│       ├── hooks/
│       │   ├── useFactCheckConfig.ts
│       │   └── useFactCheckRunner.ts
│       ├── pipeline.ts
│       ├── providers.ts
│       └── factcheck.test.ts
│
├── components/                # Truly generic / shared UI components
│   ├── LogViewer.tsx
